<div style="width:100%; height:87%; margin:auto; overflow:auto; ">
    ...
    <form method="post" action="api/edit.php">
        <table class="table text-center bek">
            ...
            <tbody>
                <tr>
                    <th scope="row"><input type="text" style="font-size:15px; padding:1px 0" name="ser_name[]" size="18" value="<?=$row['ser_name'];?>"></th>
                    <td><input type="text" style="font-size:15px; padding:1px 0" name="ser_title[]" size="15" value="<?=$row['ser_title'];?>"></td>
                    <td><input type="text" style="font-size:15px; padding:1px 0" name="ser_date[]" size="13" value="<?=$row['ser_date'];?>"></td>
                    <td><textarea name="ser_con[]" style='width:90%;height:60px'><?=$row['ser_con'];?></textarea></td>
        ...
        <div class="container mt-5 ">
            ...
            <button type="button" class="float-right mr-5 btn btn-outline-danger" onclick="op(&#39;#cover&#39;,&#39;#cvr&#39;,&#39;./modal/res_work_exp.php?table=<?=$table;?>&#39;)">新增工作經歷</button>
        </div>
    </form>
</div>